define(['index', 'request', 'map', 'preload', 'common'], function(index, request, map, preload, common) {
    // 地图
    // map.map()
    ...
    var MEDcountDownData = {
        "1": {
            "clickedAudioSrc": {
                "1": "http://live.babyfs.cn/web/H5/xl/template/2017/9/MED1/audio/baby.mp3",
                "2": "http://live.babyfs.cn/web/H5/xl/template/2017/9/MED1/audio/peekaboo.mp3",
                "3": "http://live.babyfs.cn/web/H5/xl/template/2017/9/MED1/audio/see.mp3"
            },
            "afterClickedImgSrc": {
                "1": "https://s0.babyfs.cn/op/arch/48/8571b2cf912a4af18ac0b51cef12f13d/pp/baby.png",
                "2": "https://s0.babyfs.cn/op/arch/48/8571b2cf912a4af18ac0b51cef12f13d/pp/peekaboo.png",
                "3": "https://s0.babyfs.cn/op/arch/48/8571b2cf912a4af18ac0b51cef12f13d/pp/see.png"
            }
        },
        "public": {
            "gameTimes": 1
